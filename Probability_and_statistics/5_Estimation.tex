...
\small
  ...
  $\mu_1-\mu_2$     &  $\sigma^2_1,\sigma^2_2$已知     &  $Z=\dfrac{(\bar{X}-\bar{Y})-(\mu_1-\mu_2)}{\sqrt{\sigma_1^2/n_1+\sigma_2^2/n_2}}\thicksim N(0,1)$     & $\lrp{\bar{X}-\bar{Y}\pm z_{\alpha/2}\sqrt{\dfrac{\sigma^2_1}{n_1}+\dfrac{\sigma_2^2}{n_2}}}$ \bigstrut\\\hline
   $\mu_1-\mu_2$    &  $\sigma^2_1=\sigma^2_2=\sigma^2$未知     &  $t=\dfrac{(\bar{X}-\bar{Y})-(\mu_1-\mu_2)}{S_w\sqrt{1/n_1+1/n_2}}\thicksim t(n_1+n_2-2)$     & $\lrp{\bar{X}-\bar{Y}\pm t_{\alpha/2}(n_1+n_2-2)S_w\sqrt{\dfrac{1}{n_1}+\dfrac{2}{n_2}}}$ \bigstrut\\\hline
