...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		均值放缩以得到相同项，达到相消目的
		\[0<S\leq\prod_{k=1}^{n}\frac{2k-1}{\sqrt{(2k-1)(2k+1)}}=\prod_{k=1}^{n}\sqrt{\frac{2k-1}{2k+1}}=\frac{1}{\sqrt{2n+1}}\quad\to 0(n\to\infty)\]
		\end{analysis}
		\begin{exercise}
...
\end{enumerate}
%网页链接有%始终不行
\begin{theorem}[O'Stolz定理\protect\footnote{本定理可跳过，详细内容请见\url{https://en.wikipedia.org/wiki/Stolz\%E2\%80\%93Ces\%C3\%A0ro\_theorem}}]%T143
若\begin{partlist}
